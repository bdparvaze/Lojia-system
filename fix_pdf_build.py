...
content = content.replace('staffName = obj.optString("staffName", obj.optString("name", context.getString(R.string.staff_label)))', 'staffName = obj.optString("staffName", obj.optString("name", "Staff"))')
