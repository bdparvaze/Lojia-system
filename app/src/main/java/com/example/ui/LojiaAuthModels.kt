    ...
    fun get(key: String, isBn: Boolean): String {
        return if (isBn) {
            when (key) {
                ...
                "termsText" -> "আমি শর্তাবলী এবং গোপনীয়তা নীতি মেনে চলছি এবং ব্যবসায়িক নিয়ম মেনে Lojia System ব্যবহার করার অঙ্গীকার করছি।"
                ...
                "successSub" -> "Lojia System-এ আপনাকে স্বাগতম। আপনার বিজনেস অ্যাকাউন্ট সফলভাবে তৈরি হয়েছে। এখন লগইন করুন।"
            ...
            when (key) {
                ...
                "sslText" -> "256-bit SSL encrypted · Your data is safe"
                ...
                "termsText" -> "I agree to the Terms of Service and Privacy Policy, and certify I will use Lojia System in compliance with business policies."
                "regBtn" -> "Register Business Account"
                "processing" -> "Processing…"
                "alreadyAccount" -> "Already have an account?"
                "signInLink" -> "Sign in"
                "successTitle" -> "Account Created! 🎉"
                "successSub" -> "Welcome to Lojia System. Your business account has been successfully created. You can now sign in."
