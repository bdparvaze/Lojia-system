...
data class User(
    ...
    val username: String,
    val passwordHash: String = SecurityUtils.hashSecret("admin123"),
    val role: String = "ADMIN", // ADMIN, CASHIER
    val pin: String = SecurityUtils.hashSecret("123456"),
...
data class UserProfile(
    ...
    val fullName: String = "Md. Parvaze",
    val username: String = "bdparvaze",
    val email: String = "bdparvaze.backup@gmail.com",
    val password: String = SecurityUtils.hashSecret("admin123"),
    val securityQuestion: String = "What is your primary store location?",
    val securityAnswer: String = "Lojia",
    val phone: String = "+880 1712-345678",
    val designation: String = "Owner & General Manager",
    val nationalIdOrPassport: String = "NID-8827391823",
    val address: String = "Dhaka, Bangladesh",
    val profilePictureUri: String = "",
    val avatarIndex: Int = 0,
    val dateOfBirthOrJoin: String = "15 Jan 2024",
    val emergencyContact: String = "+880 1812-987654",
    val pin: String = SecurityUtils.hashSecret("123456"),
...
data class ShopReceiptConfig(
    ...
    val customHeader: String = "Welcome to Lojia Store",
...
data class BusinessProfile(
    @PrimaryKey val id: Int = 1,
    val businessName: String = "Lojia Superstore & Cafe",
    val vatNumber: String = "310123456700003",
    val phone: String = "+880 1712-345678",
    val email: String = "contact@lojiasystem.com",
    val address: String = "Gulshan Avenue, Dhaka, Bangladesh",
    val workingHours: String = "08:00 AM - 01:00 AM",
...
enum class AppCountry(
    ...
    companion object {
        fun fromCode(code: String?): AppCountry {
            ...
            return values().find { it.code.equals(code, ignoreCase = true) || it.currencyCode.equals(code, ignoreCase = true) || it.name.equals(code, ignoreCase = true) } ?: BANGLADESH
        }
    }
}
