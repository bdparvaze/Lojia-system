...
data class ConfigurationSyncState(
    ...
    val activeCountry: AppCountry = AppCountry.BANGLADESH,
...
class ConfigurationSyncManager private constructor(private val context: Context) {
    ...
    private fun loadInitialCountry(): AppCountry {
        val code = prefs.getString(KEY_SELECTED_COUNTRY, AppCountry.BANGLADESH.code) ?: AppCountry.BANGLADESH.code
    ...
    fun setLanguage(language: AppLanguage) {
        ...
        com.example.util.LanguagePreferences.saveLanguage(context, language.code)
        scope.launch {
